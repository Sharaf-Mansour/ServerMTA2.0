...
of the following actions should you take?",ControlType.RadioButton),
            new(18, new()
            {
...
VMnat is TRUE with regards to the aspnet_wp.exe worker process? (Choose all that apply.)",ControlType.CheackBox),
            new(50, new()
            {
...
Wluiclu of the following describes the results of this configuration?",ControlType.RadioButton),
            new(51, new()
            {
...
W'uat option should you take?",ControlType.RadioButton),
            new(52, new()
            {
